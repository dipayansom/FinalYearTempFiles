...
<html>
    <head>
        ...
        <script src="Script/dynamic_list_helper.js" type="text/javascript"></script>
        
        <script type="text/javascript"src='<spring:url value="/Script/prescription.js"/>'></script>
		<link href='<spring:url value="/css/prescription.css"/>' rel="stylesheet" />
