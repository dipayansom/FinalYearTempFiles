      ...
      <div class="container">
        <div class="col-md-6 col-md-offset-3">
          <div class="signup-content">
            ...
            <form:form method="POST" id="signup-form" class="signup-form" action="commitAddPatient" commandName="patient">
			...
			<script type="text/javascript">
              ...
              <div class="form-group">
                <form:input type="text" class="form-control input-lg" path="altNumber" id="altContactNumber" placeholder="Alternate Contact Number" required="required"/>
              </div>
              ...
              <div class="form-group">
                <form:input type="text" class="form-control input-lg" path="addressLine1" id="addressLine1" placeholder="Address Line 1" required="required" />  
              </div>
